...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		...
		mHeaderView = mInflater
				.inflate(R.layout.refresh_header_lj, this, false);
		...
		// header layout
//		mHeaderProgressBar = (RelativeLayout) mHeaderView
//				.findViewById(R.id.pull_to_refresh_progress);
//		mHeaderProgressBar.setBackgroundResource(R.anim.index_anim);
//		AnimationDrawable anim = (AnimationDrawable) mHeaderProgressBar
//				.getBackground();
//		anim.start();
