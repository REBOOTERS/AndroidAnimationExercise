...
public class MyMoreText implements View.OnClickListener {
    ...
    public void getLastIndexForLimit(TextView tv, int maxLine, String content) {
        ...
        if (staticLayout.getLineCount() > maxLine) {
            ...
            //给收起两个字设成蓝色
            notEclipseString.setSpan(new ForegroundColorSpan(Color.parseColor("#ffffff")), string1.length() - 2, string1.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            ...
            if (drawable != null) {
                ...
                notEclipseString.setSpan(imageSpan, string1.length() - 1, string1.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            ...
            if (drawable != null) {
                ...
                Toast.makeText(context, "length " + string1.length(), Toast.LENGTH_SHORT).show();
                eclipseString.setSpan(imageSpan, substring.length() - 1, substring.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
