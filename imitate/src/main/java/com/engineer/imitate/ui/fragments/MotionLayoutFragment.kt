    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        motion_layout.setTransitionListener(object :MotionLayout.TransitionListener {
            override fun onTransitionTrigger(p0: MotionLayout?, p1: Int, p2: Boolean, p3: Float) {
                Log.d(
                    TAG,
                    "onTransitionTrigger() called with: p0 = $p0, p1 = $p1, p2 = $p2, p3 = $p3"
                )
            }

            override fun onTransitionStarted(p0: MotionLayout?, p1: Int, p2: Int) {
                Log.d(TAG, "onTransitionStarted() called with: p0 = $p0, p1 = $p1, p2 = $p2")
            }

            override fun onTransitionChange(p0: MotionLayout?, p1: Int, p2: Int, p3: Float) {
                Log.d(
                    TAG,
                    "onTransitionChange() called with: p0 = $p0, p1 = $p1, p2 = $p2, p3 = $p3"
                )
            }

            override fun onTransitionCompleted(p0: MotionLayout?, p1: Int) {
                Log.d(TAG, "onTransitionCompleted() called with: p0 = $p0, p1 = $p1")
            }
